...
if (isset($_GET['usar']) && is_numeric($_GET['usar'])) {
    ...
    try {
        // 1. Desativar a dieta que está atualmente ativa ('A')
        ...
        // 2. Ativar a dieta selecionada, definindo sua situação para 'A'
    ...
    // Redireciona para a página da dieta atual para ver o resultado
    header("Location: dieta.php");
    exit;
}

// CORRIGIDO: Buscar dietas desativadas, incluindo o campo 'objetivo'
